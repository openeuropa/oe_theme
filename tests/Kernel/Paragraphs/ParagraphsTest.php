...
class ParagraphsTest extends ParagraphsTestBase {
  ...
  public function testAccordions(): void {
    ...
    $actual = $crawler->filter('.ecl-accordion2__title button.ecl-accordion2__toggle .ecl-button__label')->eq(0)->text();
    ...
    $actual = $crawler->filter('.ecl-accordion2__title button.ecl-accordion2__toggle .ecl-button__label')->eq(1)->text();
