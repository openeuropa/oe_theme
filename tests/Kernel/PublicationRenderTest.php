...
class PublicationRenderTest extends ContentRenderTestBase {
  ...
  public function testTeaser(): void {
    ...
    $expected_values = [
      'title' => 'Test Publication node',
      'meta' => "Delegated directive | 15 April 2020 | Arab Common Market",
    ...
    $expected_values['meta'] = "Abstract, State aid | 15 April 2020 | Arab Common Market, ACP–EU Joint Parliamentary Assembly";
    $assert->assertPattern($expected_values, $html);
  }
