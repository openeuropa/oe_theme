...
class MinkContext extends DrupalExtensionMinkContext {
  ...
  public function checkBreadcrumbTrail(string $trail): void {
    ...
    $selector = 'ol.ecl-breadcrumb-' . $this->getEclTemplate() . '__container li.ecl-breadcrumb-' . $this->getEclTemplate() . '__segment a';
    ...
    foreach ($trail_elements as $key => $trail_element) {
      ...
      $breadcrumb_element_link = $breadcrumb_element->find('css', '.ecl-breadcrumb-' . $this->getEclTemplate() . '__link');
  ...
  public function checkBreadcrumbActiveElement(string $active_element): void {
    $selector = 'ol.ecl-breadcrumb-' . $this->getEclTemplate() . '__container li.ecl-breadcrumb-' . $this->getEclTemplate() . '__current-page';
    $breadcrumb = $this->getBreadcrumb();
  ...
  protected function getBreadcrumb(): NodeElement {
    $selector = 'nav.ecl-page-header-' . $this->getEclTemplate() . '__breadcrumb';
