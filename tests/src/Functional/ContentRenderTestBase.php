...
abstract class ContentRenderTestBase extends BrowserTestBase {
  ...
  protected function assertContactDefaultRender(NodeElement $element, string $name): void {
    ...
    $links_wrapper = $element->findAll('css', 'div.ecl-u-border-top.ecl-u-border-color-neutral-dark-50.ecl-u-mt-s div.ecl-u-border-bottom.ecl-u-border-color-neutral-dark-50.ecl-u-pt-l.ecl-u-pb-l');
