...
class ContentNewsRenderTest extends ContentRenderTestBase {
  ...
  public function testNewsRendering(): void {
    ...
    $internal_source_link = $this->assertSession()->elementExists('css', 'div.ecl-u-border-bottom.ecl-u-border-color-neutral-dark-50.ecl-u-pt-m.ecl-u-pb-m:nth-child(3)');
    $this->assertLinkIcon($internal_source_link, 'Internal source link', '/build/node', FALSE, 'xs');
    $external_source_link = $this->assertSession()->elementExists('css', 'div.ecl-u-border-bottom.ecl-u-border-color-neutral-dark-50.ecl-u-pt-m.ecl-u-pb-m:nth-child(4)');
    ...
    // Assert Body field.
    $body = $this->assertSession()->elementExists('css', 'article .ecl');
    ...
    $first_related_link = $this->assertSession()->elementExists('css', 'div.ecl-u-border-bottom.ecl-u-border-color-neutral-dark-50.ecl-u-pt-m.ecl-u-pb-m:nth-child(9) a');
    $this->assertLinkIcon($first_related_link, 'Node listing', '/build/node', FALSE, 'xs');
    $second_related_link = $this->assertSession()->elementExists('css', 'div.ecl-u-border-bottom.ecl-u-border-color-neutral-dark-50.ecl-u-pt-m.ecl-u-pb-m:nth-child(10) a');
