...
class ContentCallForProposalsRenderTest extends ContentRenderTestBase {
  ...
  public function testProposalRendering(): void {
    ...
    $results_field_group = $content_items[0]->find('css', 'div.ecl-u-border-top.ecl-u-border-bottom.ecl-u-border-color-neutral-dark-50.ecl-u-mt-l.ecl-u-mb-l.ecl-u-pt-l.ecl-u-pb-l');
