...
class ContentConsultationRenderTest extends ContentRenderTestBase {
  ...
  public function testConsultationRendering(): void {
    ...
    $publication_teaser = $content_items[5]->find('css', 'div.ecl-u-border-bottom.ecl-u-border-color-neutral-dark-50');
    ...
    $this->assertSession()->elementExists('css', 'span.ecl-icon.ecl-icon--2xs.ecl-link__icon.wt-icon--external');
