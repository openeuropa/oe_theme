...
class ContactRenderTest extends ContentRenderTestBase {
  ...
  public function testFullView(): void {
    ...
    $this->assertEmpty($crawler->filter('.ecl-u-border-top.ecl-u-border-bottom.ecl-u-border-color-neutral-dark-50.ecl-u-mt-s.ecl-u-pt-l.ecl-u-pb-l'));
    ...
    $html = $this->renderRoot($build);
    $crawler = new Crawler($html);
    $links_wrapper = $crawler->filter('div.ecl-u-border-top.ecl-u-border-color-neutral-dark-50.ecl-u-mt-s div.ecl-u-border-bottom.ecl-u-border-color-neutral-dark-50.ecl-u-pt-l.ecl-u-pb-l');
  ...
  protected function assertFeaturedMediaField(string $html, string $name): void {
    $crawler = new Crawler($html);
    $figure = $crawler->filter('.ecl-row.ecl-u-mv-xl .ecl-col-m-5 figure.ecl-media-container__figure');
