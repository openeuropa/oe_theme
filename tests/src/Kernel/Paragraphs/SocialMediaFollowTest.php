...
class SocialMediaFollowTest extends ParagraphsTestBase {
  ...
  public function testRendering(): void {
    ...
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--email'));
    ...
    $this->assertCount(0, $crawler->filter('span.wt-icon-networks--facebook'));
    $this->assertStringContainsString('Flickr', $links_html);
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--flickr'));
    $this->assertStringContainsString('Google+', $links_html);
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--google'));
    $this->assertStringContainsString('Instagram', $links_html);
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--instagram'));
    $this->assertStringContainsString('LinkedIn', $links_html);
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--linkedin'));
    $this->assertStringContainsString('Pinterest', $links_html);
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--pinterest'));
    $this->assertStringContainsString('RSS', $links_html);
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--rss'));
    $this->assertStringContainsString('Storify', $links_html);
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--storify'));
    $this->assertStringContainsString('1st Twitter', $links_html);
    $this->assertStringContainsString('2nd Twitter', $links_html);
    $this->assertCount(2, $crawler->filter('span.wt-icon-networks--twitter'));
    $this->assertStringContainsString('Yammer', $links_html);
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--yammer'));
    $this->assertStringContainsString('Youtube', $links_html);
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--youtube'));
    ...
    $this->assertCount(1, $crawler->filter('span.wt-icon-networks--facebook'));
  }
