...
class MediaParagraphsTest extends ParagraphsTestBase {
  ...
  public function testTextWithMedia(): void {
    ...
    $expected_values = [
      ...
      'caption' => 'Caption',
      'text' => NULL,
      'video' => '<iframe id="videoplayerI-163162" src="https://audiovisual.ec.europa.eu/corporateplayer/index.html?ref=I-163162&amp;lg=EN&amp;sublg=none&amp;autoplay=true&amp;tin=10&amp;tout=59" frameborder="0" allowtransparency allowfullscreen webkitallowfullscreen mozallowfullscreen width="576" height="324" class="media-avportal-content" title=" Economic and Financial Affairs Council - Arrivals"></iframe>',
      'video_ratio' => '16:9',
    ];
    $assert->assertPattern($expected_values, $html);
    $assert->assertVariant('left_simple', $html);
  ...
  public function testMediaParagraph(): void {
    ...
    $this->assertCount(1, $crawler->filter('figure.ecl-media-container__figure div.ecl-media-container__media'));
    $media_container = $crawler->filter('div.ecl-media-container__media');
    $this->assertEquals('<iframe id="videoplayerI-163162" src="https://audiovisual.ec.europa.eu/corporateplayer/index.html?ref=I-163162&amp;lg=EN&amp;sublg=none&amp;autoplay=true&amp;tin=10&amp;tout=59" frameborder="0" allowtransparency allowfullscreen webkitallowfullscreen mozallowfullscreen width="576" height="324" class="media-avportal-content" title=" Economic and Financial Affairs Council - Arrivals"></iframe>', $media_container->html());
