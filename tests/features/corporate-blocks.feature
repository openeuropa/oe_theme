...
Feature: Corporate blocks feature
  ...
  Scenario Outline: By default the European Commission footer is displayed.
    Given I am an anonymous user
    When I am on "<page>"
    Then I should see the "European Commission" footer with link "https://commission.europa.eu/index_en" image alt "European Commission logo" and title "European Commission"
  ...
  Scenario Outline: Changing the site's style will display either the European Commission or the European Union footer.
    ...
    But I should see the "European Union" footer with link "https://european-union.europa.eu/index_en" image alt "European Union flag" and title "European Union"

    When the theme is configured to use the "European Commission" style
    And I reload the page
    Then I should not see the "European Union" footer
    But I should see the "European Commission" footer with link "https://commission.europa.eu/index_en" image alt "European Commission logo" and title "European Commission"
