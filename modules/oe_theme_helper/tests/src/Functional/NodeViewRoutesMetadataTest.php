...
class NodeViewRoutesMetadataTest extends BrowserTestBase {
  ...
  public function testNodeRoutes(): void {
    ...
    $this->assertSession()->elementTextContains('css', '.ecl-page-header__intro', $published_revision_body);
    ...
    $this->assertSession()->elementTextContains('css', '.ecl-page-header__intro', $draft_revision_body);
