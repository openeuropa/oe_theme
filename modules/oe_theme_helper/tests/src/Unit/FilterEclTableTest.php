  ...
  public function processDataProvider(): array {
    return [
      ...
      'Table with zebra striping' => [
        ...
        '<p>Some text before table</p><table class="ecl-table ecl-table--zebra"><caption>Caption</caption><thead class="ecl-table__head"><tr class="ecl-table__row"><th class="ecl-table__header">Column 1</th><th class="ecl-table__header">Column 2</th></tr></thead><tbody class="ecl-table__body"><tr class="ecl-table__row"><td colspan="1" class="ecl-table__cell" data-ecl-table-header="Column 1">1-1</td><td class="ecl-table__cell" data-ecl-table-header="Column 2">1-2</td></tr><tr class="ecl-table__row"><td rowspan="1" class="ecl-table__cell" data-ecl-table-header="Column 1">2-1</td><td class="ecl-table__cell" data-ecl-table-header="Column 2">2-2</td></tr></tbody><tfoot><tr class="ecl-table__row"><td class="ecl-table__cell" data-ecl-table-header="Column 1">Footer 1</td><td class="ecl-table__cell" data-ecl-table-header="Column 2">Footer 2</td></tr></tfoot></table><p>Some text after table</p>',
      ],
      ...
      'Table with sort' => [
        ...
        '<p>Some text before table</p><table class="ecl-table ecl-table--zebra" data-ecl-table="" data-ecl-auto-init="Table"><caption>Caption</caption><thead class="ecl-table__head"><tr class="ecl-table__row"><th class="ecl-table__header" data-ecl-table-sort-toggle="">Column 1</th><th class="ecl-table__header">Column 2</th></tr></thead><tbody class="ecl-table__body"><tr class="ecl-table__row"><td colspan="1" class="ecl-table__cell" data-ecl-table-header="Column 1">1-1</td><td class="ecl-table__cell" data-ecl-table-header="Column 2">1-2</td></tr><tr class="ecl-table__row"><td rowspan="1" class="ecl-table__cell" data-ecl-table-header="Column 1">2-1</td><td class="ecl-table__cell" data-ecl-table-header="Column 2">2-2</td></tr></tbody><tfoot><tr class="ecl-table__row"><td class="ecl-table__cell" data-ecl-table-header="Column 1">Footer 1</td><td class="ecl-table__cell" data-ecl-table-header="Column 2">Footer 2</td></tr></tfoot></table><p>Some text after table</p>',
      ],
      'Table with vertical header - only class is added' => [
        ...
        '<table class="ecl-table"><tbody class="ecl-table__body"><tr class="ecl-table__row"><th class="ecl-table__cell">Row 1</th><td class="ecl-table__cell">1-1</td><td class="ecl-table__cell">1-2</td></tr><tr class="ecl-table__row"><th class="ecl-table__cell">Row 2</th><td class="ecl-table__cell">2-1</td><td class="ecl-table__cell">2-2</td></tr><tr class="ecl-table__row"><th class="ecl-table__cell">Row 3</th><td class="ecl-table__cell">3-1</td><td class="ecl-table__cell">3-2</td></tr></tbody></table>',
      ],
      ...
      'Table without any th - only general classes added' => [
        ...
        '<table class="ecl-table"><tbody class="ecl-table__body"><tr class="ecl-table__row"><td>1-1</td><td>1-2</td></tr><tr class="ecl-table__row"><td>2-1</td><td>2-2</td></tr><tr class="ecl-table__row"><td>3-1</td><td>3-2</td></tr></tbody></table>',
      ],
      'Table with cells spanning multiple rows - only general classes added' => [
        ...
        '<table class="ecl-table"><thead class="ecl-table__head"><tr class="ecl-table__row"><th class="ecl-table__header">Column 1</th><th class="ecl-table__header">Column 2</th><th class="ecl-table__header">Column 3</th></tr></thead><tbody class="ecl-table__body"><tr class="ecl-table__row"><td rowspan="2">1-1</td><td>1-2</td><td>1-3</td></tr><tr class="ecl-table__row"><td>2-2</td><td>2-3</td></tr></tbody></table>',
      ],
      'Table with cells spanning multiple columns - only general classes added' => [
        ...
        '<table class="ecl-table"><thead class="ecl-table__head"><tr class="ecl-table__row"><th colspan="2" class="ecl-table__header">Column 1</th><th class="ecl-table__header">Column 3</th></tr></thead><tbody class="ecl-table__body"><tr class="ecl-table__row"><td>1-1</td><td>1-2</td><td>1-</td></tr><tr class="ecl-table__row"><td>2-1</td><td>2-2</td><td>2-3</td></tr></tbody></table>',
      ],
      'Table with header cells spanning multiple rows - only general classes added' => [
        ...
        '<table class="ecl-table"><thead class="ecl-table__head"><tr class="ecl-table__row"><th rowspan="2" class="ecl-table__header">Column 1</th><th class="ecl-table__header">Column 2</th></tr><tr class="ecl-table__row"><th>Column 4</th></tr></thead><tbody class="ecl-table__body"><tr class="ecl-table__row"><td>1-1</td><td>1-2</td></tr><tr class="ecl-table__row"><td>2-1</td><td>2-2</td></tr></tbody></table>',
      ],
      'Table with header cells spanning multiple columns - only general classes added' => [
        ...
        '<table class="ecl-table"><thead class="ecl-table__head"><tr class="ecl-table__row"><th class="ecl-table__header">Column 1</th><th class="ecl-table__header">Column 2</th><th class="ecl-table__header">Column 3</th></tr></thead><tbody class="ecl-table__body"><tr class="ecl-table__row"><td colspan="2">1-1</td><td>1-3</td></tr><tr class="ecl-table__row"><td>2-1</td><td>2-2</td><td>2-3</td></tr></tbody></table>',
      ],
      'Table with th cell in body - only general classes added' => [
        ...
        '<table class="ecl-table"><thead class="ecl-table__head"><tr class="ecl-table__row"><th class="ecl-table__header">Column 1</th><th class="ecl-table__header">Column 2</th></tr></thead><tr class="ecl-table__row"><td>1-1</td><th>1-2</th></tr><tr class="ecl-table__row"><td>2-1</td><td>2-2</td></tr></table>',
      ],
      ...
      'Table header with invalid header - only class is added' => [
        ...
        '<table class="ecl-table"><thead class="ecl-table__head"><tr class="ecl-table__row"><th class="ecl-table__header">Column 1</th><td>Column 2</td></tr></thead><tbody class="ecl-table__body"><tr class="ecl-table__row"><td class="ecl-table__cell">1-1</td><td class="ecl-table__cell">1-2</td></tr></tbody></table>',
      ],
