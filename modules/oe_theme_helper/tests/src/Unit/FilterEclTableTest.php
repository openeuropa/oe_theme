  ...
  public static function processDataProvider(): array {
    return [
      ...
      'Table with sort' => [
        ...
        '<p>Some text before table</p><div class="ecl-table-responsive"><table class="ecl-table ecl-table--zebra" data-ecl-table data-ecl-table-sort data-ecl-auto-init="Table"><caption>Caption</caption><thead class="ecl-table__head"><tr class="ecl-table__row"><th class="ecl-table__header" data-ecl-table-sort-toggle>Column 1</th><th class="ecl-table__header">Column 2</th></tr></thead><tbody class="ecl-table__body"><tr class="ecl-table__row"><td colspan="1" class="ecl-table__cell" data-ecl-table-header="Column 1">1-1</td><td class="ecl-table__cell" data-ecl-table-header="Column 2">1-2</td></tr><tr class="ecl-table__row"><td rowspan="1" class="ecl-table__cell" data-ecl-table-header="Column 1">2-1</td><td class="ecl-table__cell" data-ecl-table-header="Column 2">2-2</td></tr></tbody><tfoot><tr class="ecl-table__row"><td class="ecl-table__cell" data-ecl-table-header="Column 1">Footer 1</td><td class="ecl-table__cell" data-ecl-table-header="Column 2">Footer 2</td></tr></tfoot></table></div><p>Some text after table</p>',
      ],
      'Table with vertical header - general and header classes are added' => [
        ...
        '<div class="ecl-table-responsive"><table class="ecl-table"><tbody class="ecl-table__body"><tr class="ecl-table__row"><th class="ecl-table__head ecl-table__header ecl-table__cell">Row 1</th><td class="ecl-table__cell">1-1</td><td class="ecl-table__cell">1-2</td></tr><tr class="ecl-table__row"><th class="ecl-table__head ecl-table__header ecl-table__cell">Row 2</th><td class="ecl-table__cell">2-1</td><td class="ecl-table__cell">2-2</td></tr><tr class="ecl-table__row"><th class="ecl-table__head ecl-table__header ecl-table__cell">Row 3</th><td class="ecl-table__cell">3-1</td><td class="ecl-table__cell">3-2</td></tr></tbody></table></div>',
      ],
      'Table with horizontal and vertical headers' => [
        ...
        '<div class="ecl-table-responsive"><table class="ecl-table"><thead class="ecl-table__head"><tr class="ecl-table__row"><th class="ecl-table__header">Column 1</th><th class="ecl-table__header">Column 2</th><th class="ecl-table__header">Column 3</th></tr></thead><tbody class="ecl-table__body"><tr class="ecl-table__row"><th class="ecl-table__head ecl-table__header ecl-table__cell" data-ecl-table-header="Column 1">Row 1</th><td class="ecl-table__cell" data-ecl-table-header="Column 2">1-2</td><td class="ecl-table__cell" data-ecl-table-header="Column 3">1-3</td></tr><tr class="ecl-table__row"><th class="ecl-table__head ecl-table__header ecl-table__cell" data-ecl-table-header="Column 1">Row 2</th><td class="ecl-table__cell" data-ecl-table-header="Column 2">2-2</td><td class="ecl-table__cell" data-ecl-table-header="Column 3">2-3</td></tr></tbody></table></div>',
      ],
      'Table without tbody' => [
      ...
      'Table with th cell in body - general and header classes are added' => [
        '<table><thead><tr><th>Column 1</th><th>Column 2</th></tr></thead><tr><td>1-1</td><th>1-2</th></tr><tr><td>2-1</td><td>2-2</td></tr></table>',
        '<div class="ecl-table-responsive"><table class="ecl-table"><thead class="ecl-table__head"><tr class="ecl-table__row"><th class="ecl-table__header">Column 1</th><th class="ecl-table__header">Column 2</th></tr></thead><tr class="ecl-table__row"><td class="ecl-table__cell" data-ecl-table-header="Column 1">1-1</td><th class="ecl-table__head ecl-table__header ecl-table__cell" data-ecl-table-header="Column 2">1-2</th></tr><tr class="ecl-table__row"><td class="ecl-table__cell" data-ecl-table-header="Column 1">2-1</td><td class="ecl-table__cell" data-ecl-table-header="Column 2">2-2</td></tr></table></div>',
      ],
