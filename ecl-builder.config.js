...
module.exports = {
  ...
  copy: [
    ...
    { from: path.resolve(nodeModules, '@ecl'), patterns: 'ec-component-gallery/*.twig', to: path.resolve(outputFolder, 'templates/components') },
    ...
    { from: path.resolve(nodeModules, '@ecl'), patterns: 'ec-component-timeline/*.twig', to: path.resolve(outputFolder, 'templates/components') },
    ...
    { from: path.resolve(nodeModules, '@ecl'), patterns: 'generic-component-gallery/*.twig', to: path.resolve(outputFolder, 'templates/components') },
    ...
    { from: path.resolve(nodeModules, '@ecl'), patterns: 'generic-component-timeline/*.twig', to: path.resolve(outputFolder, 'templates/components') },
