...
module.exports = {
  ...
  copy: [
    ...
    { from: path.resolve(nodeModules, '@ecl-twig'), patterns: 'ec-component-message/*.twig', to: path.resolve(outputFolder, 'templates/components') },
    { from: path.resolve(nodeModules, '@ecl-twig'), patterns: 'ec-component-page-banner/*.twig', to: path.resolve(outputFolder, 'templates/components') },
    { from: path.resolve(nodeModules, '@ecl-twig'), patterns: 'ec-component-page-header/*.twig', to: path.resolve(outputFolder, 'templates/components') },
    { from: path.resolve(nodeModules, '@ecl-twig'), patterns: 'ec-component-pagination/*.twig', to: path.resolve(outputFolder, 'templates/components') },
    ...
    { from: path.resolve(nodeModules, '@ecl-twig'), patterns: 'ec-component-table/*.twig', to: path.resolve(outputFolder, 'templates/components') },
    ...
    { from: path.resolve(nodeModules, '@ecl-twig'), patterns: 'ec-component-timeline/*.twig', to: path.resolve(outputFolder, 'templates/components') },
  ]
};
