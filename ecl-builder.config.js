...
module.exports = {
  ...
  copy: [
    ...
    { from: path.resolve(source_folder), patterns: 'ecl-navigation*/*.twig', to: path.resolve(__dirname, 'templates/components') },
    { from: path.resolve(source_folder), patterns: 'ecl-page*/*.twig', to: path.resolve(__dirname, 'templates/components') },
